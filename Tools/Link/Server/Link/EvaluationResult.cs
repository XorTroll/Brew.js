...
namespace Brew.Link.PC
{
    ...
    // Note that this is a simple, C# adapted clone of Brew::EvaluationResult struct from Brew.js C++ API
    public struct EvaluationResult
    {
        ...
        public static EvaluationResult decodeFromString(string Encoded)
        {
